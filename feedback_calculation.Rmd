...
RF_co2_model <-
  fN(n2o_e_co2model,n2o_a_co2model,
     (760+380)/2,1866.3,(n2o_e_co2model+n2o_a_co2model)/2)/(760-380)

RF_co2_model

RF_SE_co2_model <- err_fN(n2o_e_co2model,n2o_a_co2model,(760+380)/2,
       1866.3,(n2o_e_co2model+n2o_a_co2model)/2,
       n2o_e_SE_co2model,0)/(760-380)
...
RF_co2_LPX <-
  fN(n2o_e_co2LPX,n2o_a_co2LPX,
     (760+380)/2,1866.3,(n2o_e_co2LPX+n2o_a_co2LPX)/2)/(760-380)
...
RF_dT_model <-
  fN(n2o_e_dTmodel,n2o_a_dTmodel,
     402.88,1866.3,(n2o_e_dTmodel+n2o_a_dTmodel)/2)
...
RF_dT_LPX <-
  fN(n2o_e_dTLPX,n2o_a_dTLPX,
     402.88,1866.3,(n2o_e_dTLPX+n2o_a_dTLPX)/2)
