...
final1a <- sum(332.1*fraction*exp(0+summary(mod1)$coefficients[2,1]*log(416/380)+summary(mod1)$coefficients[3,1]*sqrt(nfer_df$nfer*10)+summary(mod1)$coefficients[4,1]*log(PPFD_total_df$PPFD_total)),na.rm=T)
 #here *10 is to convert n fertilisation unit from g/m2 to kg/ha

final3a <- sum(332.1*fraction*exp(0+summary(mod1)$coefficients[2,1]*log(813/380)+ summary(mod1)$coefficients[3,1]*sqrt(nfer_df$nfer*10)+summary(mod1)$coefficients[4,1]*log(PPFD_total_df$PPFD_total)),na.rm=T)
final1a
final3a
